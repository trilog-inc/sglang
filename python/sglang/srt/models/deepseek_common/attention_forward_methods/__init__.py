...
from .forward_mla_fused_rope_rocm import (
    DeepseekMLARocmForwardMixin as DeepseekMLAFusedRopeRocmForwardMixin,
)


class DeepseekMHARocmForwardMixin:
    """Compatibility marker for the split ROCm MHA implementation."""


class DeepseekMLARocmForwardMixin:
    """Compatibility marker for the split ROCm MLA implementation."""
