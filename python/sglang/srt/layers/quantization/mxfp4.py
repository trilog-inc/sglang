...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def _process_weights_for_sm90_cutlass(self, layer):
        ...
        # `self.num_experts` is the number of weight slots requested by the
        # quant method. It can be smaller than layer.num_local_experts when a
        # KT wrapper keeps only a hot subset on GPU.
        E = self.num_experts
